...
│                   └── soundtribe/
│                       ├── system/
│                       │   ├── AdminModerationSystemTest.java
│                       │   ├── ConcertLifecycleSystemTest.java
│                       │   ├── ExecutionLifecycleSystemTest.java
│                       │   ├── RegistrationApprovalSystemTest.java
│                       │   ├── SongLifecycleSystemTest.java
│                       │   └── UserProfileSystemTest.java
│                       ├── unit/
│                       │   ├── CommentDAOTest.java
