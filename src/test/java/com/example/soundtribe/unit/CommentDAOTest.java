...
public class CommentDAOTest {
    ...
    public void testMultipleNestedLevels() {
        Comment lvl0 = new Comment(0, testSongId, 0, 0, testUserId,
        ...
        Comment lvl1 = new Comment(0, testSongId, 0, 0, testUserId,
        ...
        Comment lvl2 = new Comment(0, testSongId, 0, 0, testUserId,
